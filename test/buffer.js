...
test('utf8 buffer to base64', function (t) {
    ...
    b.bundle(function (err, src) {
        ...
        t.equal(
            ...
            Buffer.from("Ձאab", "utf8").toString("base64")
        );
    });
});
...
test('utf8 buffer to hex', function (t) {
    ...
    b.bundle(function (err, src) {
        ...
        t.equal(
            ...
            Buffer.from("Ձאab", "utf8").toString("hex")
        );
    });
});
...
test('ascii buffer to base64', function (t) {
    ...
    b.bundle(function (err, src) {
        ...
        t.equal(
            ...
            Buffer.from("123456!@#$%^", "ascii").toString("base64")
        );
    });
});
...
test('ascii buffer to hex', function (t) {
    ...
    b.bundle(function (err, src) {
        ...
        t.equal(
            ...
            Buffer.from("123456!@#$%^", "ascii").toString("hex")
        );
    });
});
...
test('base64 buffer to utf8', function (t) {
    ...
    b.bundle(function (err, src) {
        ...
        t.equal(
            ...
            Buffer.from("1YHXkGFi", "base64").toString("utf8")
        );
    });
});
...
test('hex buffer to utf8', function (t) {
    ...
    b.bundle(function (err, src) {
        ...
        t.equal(
            ...
            Buffer.from("d581d7906162", "hex").toString("utf8")
        );
    });
});
...
test('base64 buffer to ascii', function (t) {
    ...
    b.bundle(function (err, src) {
        ...
        t.equal(
            ...
            Buffer.from("MTIzNDU2IUAjJCVe", "base64").toString("ascii")
        );
    });
});
...
test('hex buffer to ascii', function (t) {
    ...
    b.bundle(function (err, src) {
        ...
        t.equal(
            ...
            Buffer.from("31323334353621402324255e", "hex").toString("ascii")
        );
    });
});
